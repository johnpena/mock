...
is located under import path "github.com/johnpena/mock/mockgen/internal/tests/custom_package_name/client/v1".
...
This can be fixed by manually providing `-imports` flag, like `-imports client=github.com/johnpena/mock/mockgen/internal/tests/custom_package_name/client/v1`.
