...
//go:generate mockgen -destination internal/mock_gomock/mock_matcher.go github.com/johnpena/mock/gomock Matcher
...
import (
	...
	"github.com/johnpena/mock/gomock/internal/mock_gomock"
)
